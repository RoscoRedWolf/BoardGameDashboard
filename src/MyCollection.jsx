...
function MyCollection({ collection, setCollection, onRemoveGame }) {

  const handleClear = () => {
    const userConfirmed = window.confirm("Are you sure you want to clear your entire collection? : This cannot be undone.");
    if (userConfirmed) {
      setCollection([]);
    }
  }
